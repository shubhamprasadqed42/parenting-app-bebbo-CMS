  ...
  public function render() {
    ...
    $maps = [
      'height_for_age' => [
        ...
        // If you need this too, uncomment:
        // 'above +3SD'        => 'emergencyBigLengthText',.
      ],
      'height_for_weight' => [
    ...
    foreach ($this->view->result as $row_index => $row) {
      ...
      if (!isset($render['custom_growth_type'])) {
        $render['custom_growth_type'] = $row->custom_growth_type ?? NULL;
      }
      // Ensure standard_deviation present.
      if (!isset($render['standard_deviation'])) {
        $render['standard_deviation'] = $row->standard_deviation ?? NULL;
      }
